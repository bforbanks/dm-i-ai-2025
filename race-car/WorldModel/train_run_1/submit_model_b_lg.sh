#!/bin/sh
### Job: model_b_lg  —  Chunked-history transformer (d=128, L=3, large)
#BSUB -q gpuv100
#BSUB -J wm_b_lg
#BSUB -n 4
...
#BSUB -o race-car/WorldModel/gpu_logs/gpu_%J_model_b_lg.out
#BSUB -e race-car/WorldModel/gpu_logs/gpu_%J_model_b_lg.err
#BSUB -B
#BSUB -N
