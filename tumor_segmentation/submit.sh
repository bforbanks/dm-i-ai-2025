...
source venv/tumor_segmentation/bin/activate
python3 -m pip install -r requirements.txt
python3 -m pip3 install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu118
python3 trainer.py fit --config models/config_base.yaml --config models/SimpleSwin/config.yaml --config models/SimpleSwin/wandb.yaml
